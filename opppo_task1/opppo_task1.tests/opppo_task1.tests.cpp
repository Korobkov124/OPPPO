...
{
    static_assert(std::is_same<T, Animal>::value || std::is_same<T, Fish>::value || std::is_same<T, Bird>::value
...
TEST_CLASS(ParserTests){public : TEST_METHOD(TestParseDate){auto funcParseDate = [](const std::string& testLine)
...
TEST_CLASS(AnimalTests){public : TEST_METHOD(TestAddToArray){
...
{
    auto laFuncAddToArray =
        [](const std::vector<std::string>& testTokens, std::vector<std::unique_ptr<Animal>>& testArray)
...
TEST_CLASS(FishTests){public : TEST_METHOD(TestAddToArray){
...
TEST_CLASS(BirdTests){public : TEST_METHOD(TestAddToArray){
...
TEST_CLASS(InsectTests){public : TEST_METHOD(TestAddToArray){
